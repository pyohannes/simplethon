...
def main{args: List[str] -> int}(args: List[str]) -> int:
    x{int} = 10{int}
    id@1{int} = 4.5{float}.__int__{self: float -> int}()
    x{int} = id@1{int}
    y{float} = 9.3{float}
    id@2{float} = 6{int} .__float__{self: int -> float}()
    y{float} = id@2{float}
    return 0{int}
""", 0)
...
def funcint{n: int -> bool}(n: int) -> bool:
    id@1{bool} = n{int}.__lt__{self: int, n: int -> bool}(10{int})
    return id@1{bool}
...
def main{args: List[str] -> int}(args: List[str]) -> int:
    ...
    id@2{int} = funcfloat{f: float -> int}(3.14{float})
    z{bool} = funcint{n: int -> bool}(id@2{int})
    return 0{int}
""", 0)
...
def main{args: List[str] -> int}(args: List[str]) -> int:
    id@2{int} = 3.5{float}.__int__{self: float -> int}()
    x{bool} = funcint{n: int -> bool}(id@2{int})
    id@3{float} = 3{int} .__float__{self: int -> float}()
    y{int} = funcfloat{f: float -> int}(id@3{float})
    return 0{int}
""", 0)
...
def funcint{n: int -> float}(n: int) -> float:
    id@1{float} = n{int}.__float__{self: int -> float}()
    return id@1{float}
...
def main{args: List[str] -> int}(args: List[str]) -> int:
    x{int} = 10{int}
    id@1{bool} = x{int}.__bool__{self: int -> bool}()
    if id@1{bool}:
        x{int} = 2{int}
    return 0{int}
""", 0)
...
def main{args: List[str] -> int}(args: List[str]) -> int:
    x{int} = 10{int}
    id@1: id@2{bool} = x{int}.__bool__{self: int -> bool}()
    if id@2{bool}:
...
def main{args: List[str] -> int}(args: List[str]) -> int:
    x{int} = 10{int}
    id@1{int} = x{int}.__div__{self: int, n: int -> int}(3{int})
    id@2{bool} = 4{int} .__lt__{self: int, n: int -> bool}(id@1{int})
    if id@2{bool}:
        x{int} = x{int}.__sub__{self: int, n: int -> int}(1{int})
    return 0{int}
""", 0)
...
def main{args: List[str] -> int}(args: List[str]) -> int:
    ...
    y{float} = 3.4{float}
    z{bool} = True{bool}
    id@1{craw} = x{int}.__craw__{self: int -> craw}()
    sth_free{obj: craw -> }(id@1{craw})
    id@2{craw} = y{float}.__craw__{self: float -> craw}()
    sth_free{obj: craw -> }(id@2{craw})
    id@3{craw} = z{bool}.__craw__{self: bool -> craw}()
    sth_free{obj: craw -> }(id@3{craw})
    return 0{int}
""", 0)
...
def main{args: List[str] -> int}(args: List[str]) -> int:
    id@1{int} = print{a: int, b: int, c: int -> int}(1{int}, 3{int}, 4{int})
    return id@1{int}
""", 0)
...
def isprime{n: int -> bool}(n: int) -> bool:
    d{int} = 2{int}
    id@1{bool} = n{int}.__lt__{self: int, n: int -> bool}(4{int})
    if id@1{bool}:
        return True{bool}
    id@2: id@3{int} = n{int}.__div__{self: int, n: int -> int}(2{int})
    id@4{bool} = d{int}.__lt__{self: int, n: int -> bool}(id@3{int})
    if id@4{bool}:
        id@5{int} = n{int}.__mod__{self: int, n: int -> int}(d{int})
        id@6{bool} = id@5{int}.__eq__{self: int, n: int -> bool}(0{int})
        if id@6{bool}:
            return False{bool}
...
def print_primes_from{start: int, end: int -> }(start: int, end: int):
    id@7: id@8{bool} = start{int}.__le__{self: int, n: int -> bool}(end{int})
    if id@8{bool}:
        id@9{bool} = isprime{n: int -> bool}(start{int})
        if id@9{bool}:
